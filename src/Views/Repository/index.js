...
class Repository extends Component {
  ...
  render() {
    ...
    return (
      <View>
        <Header title={details.name} image={details.owner.avatar_url} />

        <Text>
          Created at: <Text>{details.created_at}</Text>{' '}
        </Text>
        <Text>
          Updated at: <Text>{details.updated_at}</Text>{' '}
        </Text>

        <Text>
          <Icon name="book" color="#000" size={18} /> Open Issues:{' '}
          {details.open_issues}
        </Text>
        <Text>
          <Icon name="info" color="#000" size={18} /> Description:{' '}
          {details.description}
        </Text>
